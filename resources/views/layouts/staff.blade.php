...
<body style="background-color: #213448;">
    <div id="app" class="d-flex">
        ...
        <div class="flex-shrink-0 p-3 bg-white" style="width: 280px; min-height: 100vh;">
            <a href="{{ url('/staff/dashboard') }}" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse show" id="dashboard-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small" style="padding-left: 35px;">
                            <li><a href="{{route('staff.dashboard')}}" class="link-dark rounded">Resident</a></li>
                            <li><a href="{{route('staff.room')}}" class="link-dark rounded">Room</a></li>
                        </ul>
                    </div>
                </li>
